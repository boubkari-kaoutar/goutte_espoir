      ...
      <div className={`px-6 sm:px-12 lg:px-20 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b ${isRTL ? 'text-right' : ''}`}
        ...
        <div className="lg:col-span-1">
          <div className="mb-5 flex justify-center">
            <div className="relative" style={{ width: '160px', height: '65px' }}>
              <Image src="/nvLogo/LOGO-GOUTTE-D'ESPOIR-.png" alt="Goutte d'Espoir" fill className="object-contain" />
            </div>
          </div>

          <p className="text-gray-400 text-[13px] leading-relaxed font-light mb-7 text-center">{t('tagline')}</p>
        ...
        <div>
          <div className={`flex items-center gap-2 mb-5 ${isRTL ? 'flex-row-reverse justify-end' : ''}`}>
            <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#327700' }} />
        ...
        <div>
          <div className={`flex items-center gap-2 mb-5 ${isRTL ? 'flex-row-reverse justify-end' : ''}`}>
            <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#1c0b64' }} />
            <span className="text-[11px] font-bold uppercase tracking-[0.22em]" style={{ color: '#1c0b64' }}>
        ...
        <div>
          <div className={`flex items-center gap-2 mb-5 ${isRTL ? 'flex-row-reverse justify-end' : ''}`}>
            <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#16390d' }} />
            <span className="text-[11px] font-bold uppercase tracking-[0.22em]" style={{ color: '#16390d' }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
              <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none"
                stroke="#327700" strokeWidth={1.8}>
                <path strokeLinecap="round" strokeLinejoin="round"
                  d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href="https://wa.me/212636227511" dir="ltr"
                className="text-gray-900 font-bold text-[14px] font-mono hover:text-[#327700] transition-colors">
                +212 636 227 511
              </a>
            </div>
          </div>
